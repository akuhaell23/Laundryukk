                ...
                <div className="card col-sm-12 my-1">
                    <div className="card-body row">
                        ...
                        <div className="col-lg-2 col-sm-12">
                            ...
                            <h6 className="text-danger">Rp { (this.getAmount(this.props.paket)).toLocaleString("id-ID") }</h6>
                        </div>
                                    ...
                                    <tbody>
                                        {this.props.paket.map((item, index) => (
                                            <tr key={item.id_paket}>
                                                ...
                                                <td>Rp {(item.paket.harga).toLocaleString("id-ID")}</td>
                                                <td>{(item.qty).toLocaleString("id-ID")}</td>
                                                <td className="text-right">Rp {(item.paket.harga * item.qty).toLocaleString("id-ID")}</td>
                                            </tr>
                                        ))}
                                        <tr>
                                            ...
                                            <td className="text-right text-danger text-bold">
                                                <h4>
                                                    Rp {(this.getAmount(this.props.paket)).toLocaleString("id-ID")}
                                                </h4>  
                                            </td>
                                        </tr>
                                    </tbody> 
